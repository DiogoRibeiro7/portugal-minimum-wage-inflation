...
their increase relative to it. A year with no listed act is otherwise
indistinguishable from a year in which the wage was genuinely frozen --- as it
was in 2012 and 2013 --- so the gap has to be closed from the law rather than
guessed at. Decreto-Lei n.º~573/99 of 30 December 1999 sets the general regime
at 63\,800 escudos in its article~1 and gives effect from 1 January 2000 in its
article~3, and it is registered here with its permanent identifier. The 2000
observation is therefore read from the act, like every other, and Eurostat's
independent compilation serves as the check on it rather than as its source.
