...
Frozen on 2015 composition, exposure takes a distinct value in every region,
running from \ExposureMinPct{} to \ExposureMaxPct{}~per cent. That is the whole
difficulty. The high-low spread is \ExposureSpreadPP{}~percentage points and the
coefficient of variation is \ExposureCV{}. Regional industry composition varies
...
in exposure. Distinct values in every region establish that a regional effect is
identified in principle; they do not establish that it is identified precisely
