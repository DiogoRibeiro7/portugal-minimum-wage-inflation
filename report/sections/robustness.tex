...
It supports nothing whatever. Not one of the \ExposureHorizons{} horizons is
significant at five per cent even by conventional clustered inference, whose
smallest $p$-value is \ExposureMinClusteredP{}; the bootstrap and the Holm
correction have nothing left to reject. This is a stronger negative than the
regional policy design produced. There, conventional inference over-rejected and
the bootstrap had to be brought in to correct it. Here the design is so
uninformative that inference known to over-reject cannot manufacture a single
false positive, and the coefficients wander as far as
